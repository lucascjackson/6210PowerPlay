...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 0.7; // X is the up and down direction
    public static double PARALLEL_Y = 6; // Y is the strafe direction

    public static double PERPENDICULAR_X = -1.25;
    public static double PERPENDICULAR_Y = 0.25;

    public static double X_MULTIPLIER = 1.00994839062;
    public static double Y_MULTIPLIER = 1.00369571218;
