...
public class BigConeAutoRight extends LinearOpMode {
    ...
    public static double pushConeX = 72;
    public static double pushConeY = 0;
    public static double pushConeAngle = 0;

    public static double lineToConeX = 63;
    ...
    public static double turnToConeAngle = Math.toRadians(269);

    public static double pickUpConeX = 46;
    public static double pickUpConeY = 20;
    public static double pickUpConeAngle = Math.toRadians(269);

    public static double lineToPoleX = 46;
    public static double lineToPoleY = -30;
    public static double lineToPoleAngle = Math.toRadians(269);

    public static double turnToPoleX = 46;
    ...
    public static double turnToParkX = 46;
    public static double turnToParkY = -10;
